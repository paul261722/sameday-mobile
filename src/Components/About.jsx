...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative w-full py-24 md:py-32 bg-gradient-to-br from-gray-900 to-black">
      ...
      <section className="py-16 container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-8 border border-orange-500/30 hover:border-orange-500/50 transition-all">
      ...
      <section className="py-12 bg-gradient-to-r from-orange-800 to-orange-600 text-white">
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center max-w-4xl mx-auto">
          <div ref={customersRef}>
            <i className="fas fa-users text-4xl mb-3"></i>
            <h3 className="text-4xl font-bold">{customersCount}+</h3>
            <p>Happy Customers</p>
          </div>
          <div ref={successRef}>
        ...
        <div className="relative z-10 container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div key={idx} className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-orange-500/20 hover:border-orange-500/50 transition-all group">
                <div className="w-14 h-14 rounded-full bg-orange-500/20 flex items-center justify-center mb-4 text-orange-400 text-2xl group-hover:scale-110 transition-transform">
      ...
      <section className="py-20 bg-gradient-to-b from-gray-900 to-black">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto mb-16">From a small workshop to Nairobi's most trusted repair service – our story is driven by passion for technology and customer care.</p>
          <div className="flex flex-wrap justify-center gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div key={idx} className="relative w-48 text-center">
                <div className="w-16 h-16 mx-auto bg-orange-600 rounded-full flex items-center justify-center text-2xl font-bold text-white mb-3">{item.year.slice(2)}</div>
                <h3 className="text-xl font-bold text-orange-400">{item.title}</h3>
                <p className="text-gray-400 text-sm mt-1">{item.desc}</p>
                {idx < 3 && <div className="hidden md:block absolute top-8 left-32 w-16 h-0.5 bg-orange-500/50"></div>}
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Call to action */}
      <section className="py-20 bg-gradient-to-r from-orange-800 to-orange-600 text-white text-center">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold mb-4">Ready to get your device repaired?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">One call, and we'll pick up your phone – repaired and returned within 24 hours.</p>
          <Link to="/booking" className="inline-block bg-white text-orange-700 px-8 py-3 rounded-full font-bold text-lg hover:bg-gray-100 transition shadow-lg">
